...
header("Location: http://v3.danielmall.com/articles/switch-creative-block/"); 
?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/functions.php"); echo "\n"; ?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/doctype.php"); echo "\n"; ?>
<head profile="http://gmpg.org/xfn/11">
    <title>&ldquo;Switch,&rdquo; an article by Dan Mall</title>
    <meta name="description" content="Dealing with creative block" />
...
<body id="article" class="articles">	
	...
	<div id="article-area-wrap">
	    ...
	    <section class="clearfix wrap vanilla">			
            ...
            <img src="creative-block.svg" alt="Creative Block" />
            ...
            <img src="switch-point.svg" alt="Switch Point" />

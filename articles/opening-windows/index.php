...
header("Location: http://v3.danielmall.com/articles/opening-windows/"); 
?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/functions.php"); echo "\n"; ?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/doctype.php"); echo "\n"; ?>
<head profile="http://gmpg.org/xfn/11">
    <title>&ldquo;Opening Windows,&rdquo; an article by Dan Mall</title>
    <meta name="description" content="Opening Windows" />
...
<body id="article" class="articles">	
	...
	<div id="article-area-wrap">
	    ...
	    <section class="clearfix wrap vanilla windows opening-windows">
            ...
            <ul>
                <li>Apple products are easy to use. From what I remember of Windows products and the little browser testing I do in firing up my cheap <abbr title="Hewlett Packard">HP</abbr> testing machine, it&rsquo;s less easy.</li>
                <li>I&rsquo;m wondering if there are things I take for granted in the iPhone/iPad/MacBook/iMac combo that will suddenly break now that I&rsquo;m on a Windows machine.</li>
                <li>Most of my worries are software-centric. There are a bunch of Mac-specific apps for which I don&rsquo;t know if there&rsquo;s a <abbr>PC</abbr> equivalent. What do I do with my <a href="https://www.sketchapp.com/">Sketch</a> files? <a href="http://mizage.com/shush/">Shush</a> is probably my most-used Mac app; is there something similar for Windows?</li>
            </ul>

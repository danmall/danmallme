...
header("Location: http://v3.danielmall.com/articles/introducing-superfriendly/"); 
?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/functions.php"); echo "\n"; ?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/doctype.php"); echo "\n"; ?>
<head profile="http://gmpg.org/xfn/11">
    <title>&ldquo;Introducing SuperFriendly,&rdquo; an article by Dan Mall</title>
    <meta name="description" content="Introducing SuperFriendly" />
    <?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/meta.php"); echo "\n"; ?>
    
    <?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/cssReference.php"); echo "\n"; ?>	
    <?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/jsReferenceHead.php"); echo "\n"; ?>
    <link rel="stylesheet" href="introducing-superfriendly.css" />
	    ...
	    <div id="comments-wrap">                
            ...
            <div class="main">
                ...
                <script>
                    ...
                    var disqus_identifier = 'introducing-superfriendly1';
                    var disqus_url = 'http://danielmall.com/articles/introducing-superfriendly1/';
    	    ...
    	    <div class="sub">
    	        ...
    	        <section class="article-info">
        	        ...
        	        <time datetime="2012-02-01T14:00:00">Published February 1, 2011 at 2:00 <abbr title="Post Meridian">PM</abbr></time>

...
header("Location: http://v3.danielmall.com/articles/get-comfortable/"); 
?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/functions.php"); echo "\n"; ?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/doctype.php"); echo "\n"; ?>
<head profile="http://gmpg.org/xfn/11">
  <title>&ldquo;Get Comfortable,&rdquo; an article by Dan Mall</title>
  <meta name="description" content="Some advice about public speaking." />
...
<body id="article" class="articles">
	...
	<div id="article-area-wrap">
	    ...
	    <section id="get-comfortable" class="clearfix wrap">
            ...
            <div class="inner">
                ...
                <p>This is so important to me for a number of reasons. In no particular order:</p>

                <ul>
                    <li>It puts the audience at ease. When you&rsquo;re comfortable, they&rsquo;re comfortable, and you all have a great time.</li>
                    <li>You&rsquo;ll feel better about everything.</li>
                    <li>You&rsquo;ll be more conversational and have a more natural pace, which lets you be seen as an approachable, honest human being. Of course, it&rsquo;s great for the audience too.</li>
                </ul>
	...
	<?php
        ...
        echo readNext('The Easiest Way to Start a Hangout', '/articles/easy-hangouts/');
	    ...
	    <div id="comments-wrap">
            ...
            <div class="main">
                ...
                <script>
                    ...
                    var disqus_identifier = 'get-comfortable';
                    var disqus_url = 'http://danielmall.com/articles/get-comfortable/';

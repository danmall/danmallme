<?php header("Location: https://superfriendlydesign.systems/articles/cooking-with-design-systems/", true, 301); ?>
...
<body class="dm-page--articleDetail">
    ...
    <div class="dm-l-articleGrid">
        ...
        <main role="main" class="dm-c-articleWell">
            ...
            <div class="dm-c-articleImage dm-u-marginTop--xl dm-u-marginBottom--xl">

	    ...
	    <section id="on-creative-direction" class="clearfix wrap">			
			...
			<section class="chunk">
				...
				<ul>
					...
					<li><strong>Art Direction:</strong> Create a set that looks like &ldquo;the everyman&rsquo;s shower&rdquo; and then transform it into a fantastical fantasyland.</li>
				...
				<p>Have you ever been so focused on writing a JavaScript method that you forget the point of the site for a minute? Or have you ever been so involved in tweaking a bezier curve that you lose sight of the how important it is to increase donations? Creative direction is about the forest <em>and</em> the trees. More specifically, it&rsquo;s about helping those in the trees see the forest, and helping those who only see the forest remember the trees too.</p>

			</section><!-- .chunk -->

			<section class="chunk">

				<h1>The role of Creative Director</h1>

				<p>Now that we&rsquo;ve established what <em>creative direction</em> is, let&rsquo;s talk about the role of Creative Director. While the fact that a Creative Director should do creative direction seems obvious, that&rsquo;s not always the case.</p>
				...
				<p>Along that same line of thinking, a literal interpretation of Creative Director would mean that someone was necessary to &ldquo;direct the creative,&rdquo; again antithetical to the setup. That resonated well with me. However, now that I&rsquo;m in a position with SuperFriendly that I&rsquo;m in a role that is traditionally a Creative Director role, I see the responsibility a bit differently. Rather than it being someone that directs the creative, I see it as someone who directs <em>what is being created</em>. That means there&rsquo;s always someone who&rsquo;s acting as Creative Director, even if the title isn&rsquo;t explicity. Who is overseeing everything being created for quality? Sometimes it&rsquo;s a producer. Other times, it&rsquo;s an information architect or a developer or a writer. Now you see how it&rsquo;s feasible for a Creative Director to come from any discipline.</p>
			...
			<section class="chunk">
				...
				<h1>Creative Directors, creative direction, and me&hellip; oh my!</h1>
				...
				<ul class="no-marker">
					...
					<li>I&rsquo;m an agency owner, looking to hire someone who can see higher-level things than my Designers and can impact my business and that of my clients. <strong>You need a Creative Director.</strong></li>
					
					<li>I&rsquo;m a Designer, looking for a mentor that can help me hone my skills so that my designs evoke just the right feel. <strong>You need an Art Director.</strong></li>

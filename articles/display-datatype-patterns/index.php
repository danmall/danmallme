...
<body id="article" class="articles">	
	...
	<div id="article-area-wrap">
	    ...
	    <section class="clearfix wrap vanilla">			
			...
			<h1 class="article-header-title">Display &amp; Datatype Patterns</h1>
			
			<p>Most of <a href="http://superfriend.ly/">SuperFriendly</a>'s work over the last few years has been with organizations that need specific help with crafting design systems that enable them to extend the work long after the "vendor" has handed off initial work. It's not uncommon to receive initial inquiries with sentences like these: </p>
            ...
            <p>A simple way to mark that up&mdash;using <a href="https://css-tricks.com/bem-101/">BEM</a> methodology&mdash;could look like this (for simplicity, I&rsquo;ve omitted useful markup like micro formats):</p>
...
&lt;/div&gt;
            ...
            <p>When I was working on <a href="http://beta.oreilly.com/">the new O&rsquo;Reilly site</a>, one of the goals our team had was to eschew traditional paper wireframes. On the previous projects we&rsquo;d worked on together, wireframes were too time-consuming to make and constrained our clients&rsquo;s thinking on design a little too much. Over <a href="http://calexico.net/">burritos</a> in the park, we realized that the most valuable thing about our previous wireframes was having a list of content for each page. </p>
            ...
            <p>This allowed both designer and developer (me and <a href="https://twitter.com/tpitre">TJ Pitre</a> respectively) to work at the same time, assembling all the parts and riffing off each other&rsquo;s work. Watching this process unfold while being part of it revealed another important insight: <em>when thinking about patterns, content strategists are primarily thinking about the data, designers are primarily thinking about the display, and front-end developers are responsible for bringing the two together.</em> Certainly a bit of an oversimplification, but I&rsquo;ve witnessed it being true more often than not. </p>

            <p>Have a look at that spreadsheet. "Four Short Links" is a particular content type. Jennifer was making sure that we wouldn't forget about that content and leaving it up to me to decide on the best display pattern for this data to be rendered across different screen sizes. That left it up to TJ to decide what level to abstract these in order to make them as reusable and easily understood as possible.</p>

            <p>[diagrams]</p>

            <p>One of the largest pitfalls in making a modular site is building to the comp. A comp is a snapshot in time, an example of elements in use, instead of being the canonical documentation for those elements. (That&rsquo;s exactly why <a href="http://danielmall.com/articles/the-post-psd-era/">comps may be an artifact of an older time in web design</a>.)</p>

            <p>It often falls to the developer to see through the pixels of a comped element to find the pattern. For most of my projects, I allocate way more time for writing HTML/CSS/JS than I do for in-Photoshop (or -Sketch or -whatever) time, because that&rsquo;s where the majority of the work&mdash;<a href="https://the-pastry-box-project.net/dan-mall/2012-september-12">making decisions</a> &mdash;happens. In fact, a quick <a href="https://www.getharvest.com/">Harvest</a> check puts TJ&rsquo;s hours on the project at more than double my own.</p>
            ...
            <p>We started to build the "From Degrees to Careers" organism&mdash;a Data pattern&mdash;but failed to initially realize that we should have been building this Display pattern:</p>
            ...
            <p>Where this all becomes really powerful is when you can have an army of Display patterns that can work with an infinite amount of Datatypes. Though we're not there yet, I could certainly see a workflow like this one in the near future of how we work on pattern-based designs.</p>

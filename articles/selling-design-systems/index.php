...
header("Location: http://v3.danielmall.com/articles/selling-design-systems/"); 
?>
...
<body id="article" class="articles">	
	...
	<div id="article-area-wrap">
	    ...
	    <section class="clearfix wrap vanilla">			
            ...
            <p>With amazing examples of public design systems like Google&rsquo;s <a href="https://www.google.com/design/spec/material-design/introduction.html">Material Design</a> and Salesforce&rsquo;s <a href="https://www.lightningdesignsystem.com">Lightning Design System</a>, it&rsquo;s easy to forget that many people still need to be convinced of the value a design system can have for an organization. </p>

            <p><a href="http://twitter.com/designerbrent/">Brent Hardinge</a>, web manager for the General Conference, knew that he&rsquo;d have to do some persuading before we&rsquo;d get the green light to work on this together. He took a few days to collect all the sites that have been created at the building he works in—not even in the rest of the organization—over the last year. He took that collection of over 100 sites and printed each out as a 3 <abbr title="inches">in</abbr>. &times; 3 <abbr>in</abbr>. thumbnail, then mounted the thumbnails on 4 mounting boards. </p>

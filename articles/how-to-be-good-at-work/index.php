    ...
    <div class="dm-l-articleGrid">
        ...
        <main role="main" class="dm-c-articleWell">        
            ...
            <div class="dm-dp-textPassage dm-l-articleGrid--main">
                ...
                <p>Maybe you wrote some code that you were proud of, and you thought, “Wow, I’m good at my job.”</p>

                <p>Or maybe someone suggested you do a little more work that you wanted to, and you declined by saying, “No thanks, I’m good with what I’m doing right now.”</p>

                <p>Or maybe you lent a co-worker some cash and thought, “I’m a good person.”</p>

                <p>Sadly, we probably don&rsquo;t acknowledge our good as often as we should. According to <a href="https://news.gallup.com/opinion/chairman/212045/world-broken-workplace.aspx">a Gallup's World Poll</a>, only 15% of the world’s 1 billion full-time workers are engaged at work. In fact, Gallup even goes so far to say we’re in an &ldquo;employee engagement crisis.&rdquo; I bet that statistic likely applies to the readers of this piece too: 85% of you are likely unengaged at your jobs, and you may not even know why.</p>


                <h2 id="project-aristotle">Project Aristotle <a class="dm-dp-anchorLink" href="#project-aristotle">#</a></h2>

                <p>In 2013, a team in Google’s People Operations&mdash;that’s what they call human resources&mdash;set out to determine what makes for effective teams at Google. Lead researcher Julia Rozovsky <a href="https://www.nytimes.com/2016/02/28/magazine/what-google-learned-from-its-quest-to-build-the-perfect-team.html">reports her findings</a>, dubbed &ldquo;Project Aristotle.&rdquo; She says, “We were pretty confident that we'd find the perfect mix of individual traits and skills necessary for a stellar team.”</p>
                ...
                <p>They found that individuals on teams with higher psychological safety are less likely to leave Google, they’re more likely to harness the power of diverse ideas from their teammates, they bring in more revenue, and they’re rated as effective twice as often by executives.</p>

                <p>So, what can you do right away to start creating more safety within your teams? Perhaps you could encourage your team to kick off meetings by sharing a risk taken in the previous week. Make that part of the culture of how you get work done. If you’re not a manager, talk to your manager about implementing something like this, and be willing to lead by example by being the first to share.</p>

                <p>Some of you might be thinking, “Yeah, that could work pretty well at my job.” But I bet others of you are thinking, “There’s no way that would work for my teams. It’s just so opposite of how we work right now.” And that’s totally fair. For some, taking risks just isn’t part of the culture of work; it’s not part of your team’s norms. Your boss tells you what to do you, and you do it, because there’s likely some consequence waiting for you if you don’t do it.</p>
                ...
                <p>If you own a house, everything inside the walls counts as part of your property. Your property also likely extends outside your house to your front yard and back yard. The boundary is clear. You get to decide who enters your property—your boundaries—and who doesn’t. Your friends and family can likely come in, at your invitation. Strangers that threaten you cannot come in, and you may even call help like the police or a really strong friend to get them outside of your boundaries completely.</p>

                <p>The same is true physically, mentally, and emotionally. You have boundaries that no one should cross unless you allow them to. Sometimes it’s easy to identify when someone crosses a boundary. If someone touches you without your permission, they’re crossing your physical boundaries.</p>

                <p>Others are more difficult to identify. When your parent guilt trips you into visiting to be a good son or daughter, they’re crossing your emotional boundaries. Luckily, like building stronger or taller fences, we can practice strengthening our boundaries and there are great resources to help us do this.</p>

                <p>TODO: Add image of boundaries book</p>

                <p>One of the my favorites is the aptly-titled <cite>Boundaries</cite> by Dr. Henry Cloud and Dr. John Townsend. In it are great nuggets like, “Boundaries let the good in and keep the bad out.” This book defines boundaries and gives examples—allegory-style—of how to put them into practice <sup class="dm-c-sidenotes--link"><a href="#note1">1</a></sup> .</p>

                <aside id="note1" class="dm-c-sidenotes dm-l-articleGrid--sidenote">

                    <p>If you’d prefer a variation that’s specific to organizations as opposed to personal relationships, there’s <cite>Boundaries for Leaders</cite>, which offers practical advice on how to manage teams, coach direct reports, and instill an organization with strong values and culture.</p>

                </aside>

                <p>TODO: Add image of Nina Brown's book</p>

                <p>Another great resource is counselor Nina Brown’s <cite>Coping with Infuriating, Mean, Critical People</cite>. She describes four types of boundaries:</p>
                ...
                <p>Having flexible boundaries are what all of us can likely do better. Let’s have a look at flexible boundaries in action.</p>
                ...
                <p>For those that learn and practice boundaries for the first time, there’s often a big initial reaction: <strong>but isn&rsquo;t that rude?</strong> Let’s be clear: it’s not rude. It’s not rude to say no to someone. It’s not rude to want something different than everyone else and stand up for it. Quinta wasn’t obnoxious or off-putting; she was pleasant and accommodating, but she still made she sure that <em>she</em> was in control of what she wanted.</p>

                <p>There’s a complex concept in the Boundaries book: “<strong>We are responsible <em>to</em> others and <em>for</em> ourselves.</strong>” The corollary is that we are not responsible for others. The other two guys in this video were probably worried about hurting Justin’s feelings. And that’s where the complexity sneaks in: by making themselves responsible for Justin’s feelings, by taking that on themselves, they’re actually encroaching on Justin’s boundaries in making assumptions on behalf of his emotions. They’re probably well-intentioned, but that doesn’t change the fact that it’s still a boundary violation.</p>
                ...
                <p>I was fortunate to hear him speak at Brooklyn Beta in 2012. During the <abbr title="Question and Answer">Q&amp;A</abbr> session, someone asked how he and his team are able to achieve such incredible results. He responded by saying that they all hold each other accountable and proceeded to share his formula for accountability. There are 3 parts:</p>
                ...
                <p>Imagine you’re talking to your manager. You might say something like:</p> 
                ...
                <p>This can easily be measured. Your manager may check the staging server at 5:01pm to test this functionality to see if it’s working.</p>

                <p>The last piece of creating accountability is that there must be effects, either positive or negative once those standards are measured. If that upload functionality works by 5:01pm, you get a promotion! But if it doesn’t work—or worse: isn’t there—by 5:01pm you get fired.</p>

                <p>Ok, so that’s a pretty extreme and unlikely example. Maybe this is more realistic. If that upload functionality works by 5:01pm, our client will probably sign more work with us. But if it doesn’t work—or worse: isn’t there—by 5:01pm, they probably won't renew the account.</p>

                <p>If your teams aren’t being productive, there’s a chance it’s because people aren’t being held accountable. You can use this framework to help correct that; it’s at least worth a shot.</p>

                <p>Where I’ve seen a lot of teams fall down is in the first piece: teams struggle to define standards well. Next time you’re in a meeting and you hear someone punt on defining standards by trying to finish the conversation with something like, “Well, let’s see how it turns out,” speak up. You can say something like, “Wait, can we try to define that a little more specifically so we know what we’re accountable for?” Little conversational cues like that can go a long way.</p>



                <h2 id="commit-to-commit">Commit to commit <a class="dm-dp-anchorLink" href="#commit-to-commit">#</a></h2>

                <p>Once everyone’s on board with that idea, the next step is to create some commitments. Here’s where boundaries come back into play. You want to create accountability without violating anyone’s boundaries. A great way to d o that is to ask a closed-ended question, a question that you can only answer with “yes” or “no” <sup class="dm-c-sidenotes--link"><a href="#note2">2</a></sup> .</p>
                ...
                <blockquote><p><strong>Can you</strong> finish the document upload functionality by 5pm today?”</p></blockquote>

                <p>The phrase “can you” allows the other person to make their own decisions. It respects their boundaries.</p>

                <p>What if you’re on the other end of this? What if your boss comes up to you and asks you this? That’s not always a comfortable spot to be in.</p>
                ...
                <p>This is really powerful. What’s your boss looking for? They just want to know what to expect. And you’re letting them know that, very soon, they’ll know what to expect.</p>
                ...
                <p>This is no longer just an interrogation about accountability; it’s a conversation about it.</p> 

                <p>Let’s take what we’ve learned so far and see if we can debunk one of the most used but most toxic strategies. </p>
                ...
                <p>What happened here? Above all, I think people just want to know what to expect. They want to know that your word means something, that when you say you’ll do it, you’ll do it.</p>

                <p>Now, there’s nothing wrong with being wrong. If at 3pm, you don’t think you can get something done but at 5pm you realize it was easier than you initially thought, that’s great! But own it. Don’t celebrate finishing early before you apologize for setting the wrong expectations. That way, your client will know that you value your word as much as they want to <sup class="dm-c-sidenotes--link"><a href="#note4">4</a></sup>.</p>
                ...
                <p>One of my philosophies about doing client work—and this applies equally if your client is instead a manager or another internal stakeholder—is to <strong>show clients the future</strong>. Let them know what’s coming up.</p> 

                <p>For every client, I set up a <a href="https://github.com/SuperFriendly/project-hub">Project Hub</a> on a new subdomain. It’s a simple list of all of the upcoming milestones. As we go, it’s ok if things shift, but we’re always trying to reset expectations so the client always has an accurate view that’s far out as we can confidently say.</p>



                <h2 id="motivation">Motivation <a class="dm-dp-anchorLink" href="#motivation">#</a></h2>

                <p>One of the tough things about accountability is that you may run into someone that’s honestly difficult to make accountable. Despite trying to establish standards, conceiving a great way to measure those, and having appropriate effects, nothing seems to be working. In that scenario, chances are pretty high that you’re dealing with an unmotivated colleague or direct report.</p>

                <p>Maybe that person is you, despite trying your best to drum up the interest to no avail.</p>

                <p>I recently worked with a startup that asked me to coach their teams to level up their collaborative processes. In particular, they thought the designers’ work wasn’t exactly up to snuff with what they could be producing, so they asked me to see what I could unearth. They don’t have a head of design, so the head of engineering has been standing in as head of design to get the designers moving.</p>

                <p>When I asked the head of engineering what the root of the problem might be, he said, “Listen, we have to ship this product so we don’t have a lot of time to explore. We have to execute.”</p>

                <p>When I asked the designers what the root of the problem might be, they said, “We’re just taking orders designing what everyone tells us to do.”</p> 

                <p>How do you fix this scenario?</p>

                <p>TODO: Drive book cover</p>

                <p>In Daniel Pink&rsquo;s <cite>Drive</cite>, he describes a framework for what drives people, what motivates them:</p>
                ...
                <p>The designers had none of these three, so it wasn’t surprising that they didn’t feel driven or motivated. People were telling them what to design, so they had no autonomy; they couldn’t direct their own lives. They were being managed by someone who didn’t know their skills, so they had little idea for how to make progress. The startup is in financial services, a category the designers didn’t have too much interest in, so there wasn’t a lot of purpose in it for them either.</p>
                ...
                <p>TODO: Leaders eat last image</p>

                <p>Simon Sinek is probably best known for <a href="https://www.ted.com/speakers/simon_sinek" title="Simon Sinek on TED">his TED talks</a> and his book <cite>Start with Why</cite>, but his book <cite>Leaders Eat Last</cite> is my favorite. It gives so many great tips and examples for how teams can be better supporting each other.</p>

                <p>In the book, Sinek tells the story of an employee at manufacturing company whose diabetic wife needed surgery. The employee couldn’t afford to lose pay, so his fellow employees transferred their own paid vacation days so he could have more paid days off. The company had never done something like this before, and it was actually in clear violation of official company policy. But they made it happen anyway. It’s a touching tale of how people band together to reduce each other’s risk.</p>

                <p>Sinek also tells the story of a tech company <a href="http://www.nextjump.com/">Next Jump</a>’s Lifetime Employment Policy: once you get hired, you can never be fired (unless you actively worked to undermine your colleagues or do something illegal). If you perform poorly, you get coached. <abbr title="Chief Executive Officer">CEO</abbr> Charlie Kim thinks of taking care of his employees like raising kids. He says, “Most people would never get rid of there kids in hard times, so how can we lay off our people under the same conditions?”

                <p>Here’s a simple illustration of how are organizations currently work, but how they could be so much more.</p>
                ...
                <p>My last tip: go around to each member of your team and ask them what you can do for them today. Don’t take no for an answer (while still respecting their boundaries!). It could be work-related, like converting a database or naming all the layers in a Sketch file. Or it could be as small as making sure everyone has a fresh glass of water once an hour.</p>

                <p>This is the kind of stuff that makes not only our workplaces good, but our neighborhoods, and cities, and countries too. This is the stuff you won’t pick up in a coding bootcamp or in a Github repo, but it can make all the difference for <strong>how to be good at work</strong>.</p>

...
header("Location: http://v3.danielmall.com/articles/techcrunch-responsive-redesign/"); 
?>
...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="stylesheet" href="//cloud.webtype.com/css/915a93dd-284e-48a6-8968-33ad1e62da86.css" />
            ...
            <section class="chron">
                ...
                <article class="event" id="initial-contact">
                    <div class="event-main">
                        ...
                        <p>I get an email from <a href="http://globalmoxie.com/">Josh Clark</a>, an internet friend that I&rsquo;d never actually met before. Josh tells me that he needs a designer for a few projects coming up and that he&rsquo;d love to work together, which was music to my ears. The first project he has on the horizon is a responsive redesign of <a href="http://techcrunch.com/">TechCrunch</a>. We continue to flatter each other for a few emails as we discussed rates and timelines, and Josh tells me about the potential all-star team of interaction designer <a href="https://twitter.com/jenniferbrook">Jennifer Brook</a>, front-end designer <a href="http://bradfrostweb.com/">Brad Frost</a>, mobile strategy consultant <a href="http://jonathanstark.com/">Jonathan Stark</a>, and project manager <a href="http://www.linkedin.com/in/kristinafrantz">Kristina Frantz</a>. Sold!</p>
                    </div><!-- .event-main -->
                </article><!-- .event -->
                ...
                <article class="event" id="prescreen">
                    <div class="event-main">
                        ...
                        <p>Our first call with TechCrunch as a group. We talk about things like how we&rsquo;d work together as a big team, how quickly we can be iterative, how invested they are in trying to achieve a great design they&rsquo;re proud of, and how possible it was to get quickly into code.</p>
                    </div><!-- .event-main -->
                </article><!-- .event -->

...
<head profile="http://gmpg.org/xfn/11">
  ...
  <script>
    try{
        Typekit.load();
        document.write('<link rel="stylesheet" href="sketchlive-typekit.css" />');
    }catch(e){}
  </script>
...
<body id="article" class="articles">
	...
	<div id="article-area-wrap">
	    ...
	    <section id="sketchlive" class="clearfix wrap hentry">
            ...
            <blockquote class="twitter-tweet" data-conversation="none" lang="en"><p>Day 2 of <a href="https://twitter.com/hashtag/sketchlive?src=hash">#sketchlive</a> starts now. Goals for today: discover how good <a href="https://twitter.com/sketchapp">@sketchapp</a> is at allowing for a range of styles. I definitely see…</p>&mdash; Dan Mall (@danielmall) <a href="https://twitter.com/danielmall/status/510084996292698112">September 11, 2014</a></blockquote>

            <p>I decided to replicate the <a href="http://www.meetyourmx.com/">Meet Your MX</a> site, expertly designed by <a href="https://twitter.com/brijanp">Brijan Powell</a>. I loved this site from the instant I saw it, because I think it contains a lot of richness in typographic design, graphic design, and interaction design that I think is missing from a lot of sites nowadays. A good design tool should allow me to design a site like this without much friction. A great design tool should make it easier for me to design a site like this.</p>
            ...
            <ul>
              <li><strong>Export tools.</strong> By far the most impressive feature for me. Being able to select any layer or group and hit Cmd+Shift+E to generate an image&mdash;in lots of resolutions&mdash;and drag it out to anywhere is priceless. And lightning fast to boot? Photoshop&rsquo;s Save for Web has a lot to learn from Sketch&rsquo;s exporting.</li>

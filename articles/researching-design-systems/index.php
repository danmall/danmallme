...
<body id="article" class="articles">
	...
	<div id="article-area-wrap">
      ...
      <section class="box box__nasa">
        ...
        <h1>National Aeronautics and Space Administration Graphics Standards Manual</h1>

        <blockquote>
          <p>[The logo] was accepted by the arts commission, though reluctantly, with a note about its &ldquo;imited sculptural possibilities.&rdquo;</p>
        ...
        <p>&ldquo;&hellip;if government publications—from tax returns to road signs—were attractive and easy to read, people would read them and respect them&hellip; the morale and the productivity of our public servants would rise dramatically if they could work in a decent environment.&rdquo;</p>
      ...
      <section class="box box__material">
        ...
        <p class="url"><a href="https://material.google.com/">material.google.com</a></p>
      ...
      <section class="box box__ios">
        ...
        <h1>iOS Human Interface Guidelines</h1>
        <p class="url"><a href="https://developer.apple.com/ios/human-interface-guidelines/">developer.apple.com/ios/human-interface-guidelines/</a></p>

        <p>One thing that strikes me most about the iOS Human Interface Guidelines over other design systems is that it feels as much like a marketing site as it does documentation. The other systems I&rsquo;ve reviewed feel more like specifications; though well-written, they do feel a bit dry. Perhaps, in true Apple fashion, the housing for the guidelines feels like it&rsquo;s <em>selling</em> me a bit, enticing me to use it the way a good SaaS site does. It occurs to me that any design system that needs to do some amount of evangelizing—i.e. all of them—should have a bit of sales pitch in them.</p>
      ...
      <section class="box box__airbnb">
        ...
        <h1>Airbnb Design Language System</h1>
      ...
      <section class="box box__slds">
        ...
        <h1>Salesforce Lightning Design System</h1>
        <p class="url"><a href="https://www.lightningdesignsystem.com/">lightningdesignsystem.com</a></p>
      ...
      <section class="box box__ibm">
        ...
        <h1>IBM Design Language</h1>
        <p class="url"><a href="http://www.ibm.com/design/language/">ibm.com/design/language/</a></p>

        <p>There are 2 specific things I really appreciate about the IBM Design Language:</p>

        <p>Right up front, they make it clear that the purpose of their design system is to foster a consistency that supports their brand:</p>
      ...
      <section class="box box__misc">
        ...
        <p>I think that&rsquo;ll be my first metric for success. If the design system we create for this client can be specific about what makes a great [company name] site or app and why it&rsquo;s better in-context than any one of the systems listed above, I&rsquo;d say we&rsquo;re headed in the right direction. That&rsquo;s a tall order and I&rsquo;m a pretty short guy, but that&rsquo;s never stopped me before.</p>

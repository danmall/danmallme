...
header("Location: http://v3.danielmall.com/work/logos/"); 
?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/functions.php"); echo "\n"; ?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/doctype.php"); echo "\n"; ?>
<head>
    <title>Assorted Logos by Dan Mall</title>
	    ...
	    <section id="work-area" class="wrap800">
	        ...
	        <div id="project-header">
        	    ...
        	    <span id="facebook-like">
        	        <iframe src="http://www.facebook.com/plugins/like.php?href=http://danielmall.com//work/logos/" scrolling="no" frameborder="0" style="border:none; height: 30px;"></iframe>
        	    </span>

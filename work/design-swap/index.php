...
header("Location: http://v3.danielmall.com/work/design-swap/"); 
?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/functions.php"); echo "\n"; ?>
<?php require($_SERVER["DOCUMENT_ROOT"]."/-/_inc/doctype.php"); echo "\n"; ?>
<head>
    <title>&ldquo;Design Swap,&rdquo; work by Dan Mall</title>
	    ...
	    <section id="work-area" class="wrap800">
	        ...
	        <div id="project-header">
        	    ...
        	    <span id="facebook-like">
        	        <iframe src="http://www.facebook.com/plugins/like.php?href=http://danielmall.com//work/design-swap/" scrolling="no" frameborder="0" style="border:none; height: 30px;"></iframe>
        	    </span>
        ...
        <section id="work-content" class="wrap">
            ...
            <div class="main">
                ...
                <section id="bibliography">
                    ...
                    <ul>
                        <li><a href="http://www.thedesigncubicle.com/2010/07/design-swap-a-day-in-the-life-of-dan-mall/">My Design Swap: A Day in the Life of Dan Mall,</a> by Brian Hoff</li>
                        <li><a href="http://design-swap.com/2010/07/06/a-day-in-the-life/">A Day in the Life,</a> by Design Swap</li>
                    </ul>

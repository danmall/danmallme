	...
	<div id="article-area-wrap">
	    ...
	    <section id="prequalifying-clients" class="clearfix">
            ...
            <section id="teams" class="topic">
                ...
                <div class="col2">
                    <p>On the literal end, it&rsquo;s good to know who you&rsquo;re working with. Is it a group of middle managers? What kind of red tape are you dealing with? Even if you&rsquo;re dealing with someone that has decision-making power, will she have the availability to respond as quickly as you&rsquo;ll need her to? We&rsquo;ve often had to request certain roles on the client end (like project managers or supporting designers) to make sure our work gets put to good use.</p>
                </div><!-- .col2 -->
            ...
            <section id="compensation" class="topic">
                ...
                <div class="col2">
                    <p>Here&rsquo;s the trick. Ask them, &ldquo;Is your budget closer to $5K, $50K, or $500K?&rdquo;</p>
            ...
            <section id="scope" class="topic">
                ...
                <div class="col1">
                    <p>The catch all. Time for closing statements. Make sure you don&rsquo;t miss anything.</p>
                </div><!-- .col1 -->
